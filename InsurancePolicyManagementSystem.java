...
public class InsurancePolicyManagementSystem {
    public static void main(String[] args) {
        ...
        Policy p1 = new Policy("P123", "Parth Goyal", exp1, "Health", 5000.0);
        Policy p2 = new Policy("P124", "Shanya Sharma", exp2, "Health", 1700.0);
        Policy p3 = new Policy("P125", "Priyanshi Mangal", exp1, "Home", 2900.0);
        system.addPolicy(p1);
        system.addPolicy(p2);
        system.addPolicy(p3);
        system.addPolicy(p1); 
