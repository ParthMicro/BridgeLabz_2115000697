...
public class Main {
    public static void main(String[] args) {
        School school = new School("Gwalior Glory High School");
        Student student1 = new Student("Parth Goyal");
        Student student2 = new Student("Tushar Singh Pawaiya");
        Student student3 = new Student("Sarthak Jain");
